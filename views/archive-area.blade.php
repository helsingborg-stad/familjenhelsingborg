...
<div class="container main-container">
    ...
    <div class="grid">
        ...
        @elseif (get_field('archive_' . sanitize_title($postType) . '_filter_position', 'option') == 'left')
            @include('partials.archive-filters-left')
        @endif
        ...
        <?php
            ...
            //LeftFilter
            if ($cols == 'grid-md-12' && get_field('archive_' . sanitize_title($postType) . '_filter_position', 'option') == 'left') {
                $cols = 'grid-xs-12 grid-lg-8 grid-xl-7';
            }
        ?>
